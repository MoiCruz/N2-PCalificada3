  ...
  return (
    ...
    <Appbar />
     ...
     <div className='w-full bg-gradient-to-bl from-amber-50 via-slate-100 to-slate-100 md:h-screen justify-items-center relative'>
         <img src="../public/2.services/illustration1.png" alt="" className='size-72 absolute ms-72 my-30' />
         <div className=' justify-items-center w-xl pt-5'>
           <h1 className='font-black text-4xl'>Service</h1>
           <p className=' text-center pt-6 pb-22 text-gl'>We offer youth with chances for career development in their practice. We also support a wide range of services to ensure client satisfaction</p>
         </div>
